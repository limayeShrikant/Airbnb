class Review < ApplicationRecord
  ...
  validates :acccuracy_rating, numericality: { only_integer: true, greater_than_or_equal_to: 1, less_than_or_equal_to: 5 }
  ...
  def update_final_rating
    total_rating = cleanliness_rating + acccuracy_rating + checkin_rating + communication_rating + location_rating + value_rating
